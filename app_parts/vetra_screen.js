...
el.highlightTrigger.addEventListener("click", () => { pause_for_choice(); el.highlightDialog.showModal(); (el.highlightDialog.querySelector("[data-highlight-theme]:checked") || el.highlightDialog.querySelector("[data-highlight-theme]")).focus(); announce("Vetra color options opened. Playback paused."); });
