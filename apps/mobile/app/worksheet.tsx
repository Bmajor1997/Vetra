...
export default function Worksheet(){
 ...
 <View style={s.intro}><Text style={[s.heading,{color:theme.text}]}>Complete your worksheet</Text><Text style={[s.body,{color:theme.mutedText}]}>Your responses are saved on this device as you work.</Text></View>
