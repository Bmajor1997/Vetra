...
export default function Notes(){
  ...
  return <Screen title="Notes">
    ...
    </Pressable>)}</View>:<EmptyState
      image={searching?require("../assets/empty-states/search-empty.png"):filter==="saved"?require("../assets/empty-states/highlights.png"):require("../assets/empty-states/notes.png")}
      imageAccessibilityLabel={searching?"A magnifying glass representing no search results":filter==="saved"?"A highlighter marking saved passages":"A notebook and pencil for saved notes"}
      title={searching?"No matches":filter==="saved"?"No saved passages yet":"No notes yet"}
      description={searching?"Try another search or filter.":filter==="saved"?"Save a passage in the Reader. It will appear here automatically.":"Save a passage in the Reader and add a note. It will appear here automatically."}
    />}
  </Screen>;
}
