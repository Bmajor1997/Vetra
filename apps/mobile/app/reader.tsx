...
export default function Reader(){
  ...
  return <SafeAreaView style={[s.safe,{backgroundColor:theme.background}]}>
    <View style={s.content}>
      ...
      <View style={s.player}>\n        <Pressable accessibilityRole="button" accessibilityLabel="Ask Votic about this document" onPress={()=>{void stop();router.push("/assistant")}} style={({pressed})=>[s.ask,{borderColor:theme.border,backgroundColor:pressed?theme.surfaceMuted:"transparent"}]}><Ionicons name="chatbubble-ellipses-outline" size={20} color={theme.text}/><Text style={[s.askText,{color:theme.text}]}>Ask Votic</Text></Pressable>
