  ...
  return <SafeAreaView edges={["top","bottom","left","right"]} style={[s.safe,{backgroundColor:theme.background}]}>
    <View style={s.content}>
      ...
      <ScrollView ref={scrollRef} style={s.textArea} contentContainerStyle={s.readingContent}>
        ...
        <Pressable accessibilityRole="button" accessibilityLabel="Ask Votic about this document" onPress={()=>{void stop();router.push("/assistant");}} style={({pressed})=>[s.readingAsk,{borderColor:theme.border,backgroundColor:pressed?theme.surfaceMuted:theme.surface}]}><Ionicons name="chatbubble-ellipses-outline" size={20} color={theme.accent}/><Text style={[s.readingAskText,{color:theme.accent}]}>Ask Votic about this document</Text><Ionicons name="arrow-forward" size={18} color={theme.accent}/></Pressable>
      </ScrollView>
