...
export default function Documents(){
  ...
  return <Screen title="Documents">
    <Pressable accessibilityRole="button" accessibilityLabel="Add document" accessibilityHint="Choose a document from this device" disabled={importing} onPress={addDocument} style={({pressed})=>[s.add,{backgroundColor:theme.accent,opacity:importing?.6:pressed?.78:1}]}><Ionicons name="add" size={22} color="#FFF"/><Text style={s.addText}>{importing?"Importing…":"Add document"}</Text></Pressable>
