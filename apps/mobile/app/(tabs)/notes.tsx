...
export default function Notes(){
  ...
  return <Screen title="Notes">
    ...
    </Pressable>)}</View>:<View style={s.empty}><Ionicons name="bookmarks-outline" size={34} color={theme.mutedText}/><Text style={[s.emptyTitle,{color:theme.text}]}>{query?"No matches":"No notes yet"}</Text><Text style={[s.emptyCopy,{color:theme.mutedText}]}>{query?"Try another search or filter.":"Save a passage in the Reader and add a note. It will appear here automatically."}</Text></View>}
  </Screen>;
}
