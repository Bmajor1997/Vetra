...
export default function RootLayout(){return <ThemeProvider><AccessibilityProvider><DocumentLibraryProvider><Stack screenOptions={{headerShown:false}}><Stack.Screen name="(tabs)"/><Stack.Screen name="reader"/><Stack.Screen name="assistant"/><Stack.Screen name="worksheet"/></Stack></DocumentLibraryProvider></AccessibilityProvider></ThemeProvider>}
