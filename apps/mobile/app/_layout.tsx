...
export default function RootLayout(){return <ThemeProvider><AccessibilityProvider><DocumentLibraryProvider><RoutineProvider><Stack screenOptions={{headerShown:false}}><Stack.Screen name="(tabs)"/><Stack.Screen name="reader"/><Stack.Screen name="assistant"/><Stack.Screen name="worksheet"/><Stack.Screen name="review"/><Stack.Screen name="recap"/></Stack></RoutineProvider></DocumentLibraryProvider></AccessibilityProvider></ThemeProvider>}
